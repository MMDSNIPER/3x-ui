...
// RequireOwner aborts with 403 if the logged-in user is not the owner.
...
// InjectInboundAccess stores the allowed inbound IDs on the context
// so downstream handlers can filter without re-loading the user.
